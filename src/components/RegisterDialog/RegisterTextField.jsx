...
const RegisterTextField = ({ field, value, label, helperText, onChange, errors = {}, icon: Icon, type = "text" }) => {
				...
				input: {
					startAdornment: (
						<InputAdornment position="start">
							<Tooltip title={errorMessages} arrow placement="bottom-start" open={hasErrors}>
								<span>
									<IconButton disableTouchRipple disabled={!hasErrors} style={{ color: "rgba(0, 0, 0, 0.26)" }}>
										{hasErrors ? <PriorityHighRounded style={{ color: "rgba(255, 0, 0, 0.52)" }} /> : <Icon />}
									</IconButton>
								</span>
							</Tooltip>
						</InputAdornment>
