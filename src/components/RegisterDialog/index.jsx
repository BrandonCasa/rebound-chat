...
const RegisterDialog = () => {
	const { registerDialogState, activeStep, formData, handleFormDataChange, handleStayLoggedInChange, handleNextStep, handleBackButton, handleDialogClose, handleToLogin } = useRegisterDialog();
