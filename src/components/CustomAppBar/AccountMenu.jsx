...
const AccountMenu = ({ anchorEl, open, handleClose, handleLogout, theme }) => (
	<Menu anchorEl={anchorEl} open={open} onClose={handleClose} sx={{ mt: 1 }} transformOrigin={{ horizontal: "right", vertical: "top" }} anchorOrigin={{ horizontal: "right", vertical: "bottom" }}>
		<MenuList>
			<MenuItem>
				<ListItemIcon>
