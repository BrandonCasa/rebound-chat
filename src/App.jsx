...
const LandingPage = lazy(
  () => import("./routes/LandingPage/LandingPage.route"),
);
const ProfilePage = lazy(
  () => import("./routes/ProfilePage/ProfilePage.route"),
);
const ChatPage = lazy(() => import("./routes/ChatPage/ChatPage"));
const ServersPage = lazy(
  () => import("./routes/ServersPage/ServersPage.route"),
);
const TestingPage = lazy(
  () => import("./routes/TestingPage/TestingPage.route"),
);
const SettingsPage = lazy(
  () => import("./routes/SettingsPage/SettingsPage.route"),
);
...
const App = () => {
        ...
        if (authState.authToken && !authState.loggedIn) {
          ...
          try {
            ...
            dispatch(
              addSnackbar({
                snackbarMsg:
                  "Failed to verify user. Please try logging in again.",
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      ...
      <CssBaseline />
      <SnackbarMapper
        drawerWidth={customAppBarProps.drawerWidth}
        drawerOpen={customAppBarProps.drawerOpen}
      />
      <AppRouter>
        <RegisterDialog />
        <LoginDialog />
