...
function ChatPage() {
	...
	useEffect(() => {
		...
		if (authState.loggedIn === true && socketClient !== null) {
			...
			dispatch(addSnackbar({ snackbarMsg: `Login or register to use this page.`, snackbarSeverity: "warning", autoHideDuration: 3000 }));
		}
	...
	}, [authState.loggedIn, authState.socketInfo.connected, authState.loggingIn]);
