...
| GET    | [`/users/google`](endpoints/users_google.md)               | Begin Google OAuth2 login. Redirects to Google.                                                                               |
| GET    | [`/users/google/callback`](endpoints/users_google.md)      | OAuth2 callback. Redirects back with a token.                                                                                 |
