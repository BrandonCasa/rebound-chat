...
const liveConfig = Object.freeze({
	...
	maxRetainedSegments: parsePositiveInt(process.env.LIVE_MAX_RETAINED_SEGMENTS, 18),
	maxRetainedSegmentsCap: parsePositiveInt(process.env.LIVE_MAX_RETAINED_SEGMENTS_CAP, 240),
